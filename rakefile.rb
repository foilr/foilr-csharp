...
RESULTS_DIR = "results"
PRODUCT = "Foilr"
COPYRIGHT = 'Copyright 2012 Foilr. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/Foilr.sln', :clrversion => CLR_TOOLS_VERSION
